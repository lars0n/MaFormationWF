...
// je crée la variable $errors pour retirer les erreurs undefined et je lui affecte la valeur faux
$order = '';
$errors = [];
...
if(!empty($_POST)) {
    ...
    if (!$errors) {
        ...
        if ($insertUser->execute()) {
            ...
            // je le laisse mais ce n'est pas pertinent d'indiquer qu'il y'a eu une erreur SQL
            $errors[] = 'Erreur SQL';
        }
    }
}
